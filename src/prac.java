...
public class DataMunger {
	...
	public static void main(String[] args) {
		...
		String queryString=k.nextLine().toLowerCase();
	...
	public String getConditionsPartQuery(String queryString) {
		if (queryString.contains("where")==true) {
		int i;
		String[] conditionPart=queryString.split("where");
		int n=conditionPart.length;
		String[] next=conditionPart;
		for(i=1;i<n;i++)
	    next[i]=conditionPart[i].split("order by")[0].split("group by")[0];
		String result=next[1];
		for(i=2;i<n;i++)
	...
	public String[] getConditions(String queryString) {
		...
		String[] splitString=queryString.split("where")[1].split("or ");
		
	
		String[] next= {splitString[0].trim(),splitString[1]};
		...
		for(i=0;i<n;i++) {
		    ...
		    if (splitString[i].contains("=")) {
		    	...
		    	System.out.println(thisString[1]);
		    	 ...
		    	 returnthis[0]= thisString[0];
		    	 returnthis[1]= "=";
		    	 returnthis[2]= thisString[1];
	...
	public String getOrderByFields(String queryString) {
		if (queryString.contains("order by")==true) {
